...
$('.submit-button').click(function () {
  ...
  if ($correctAnswer1.prop('checked') && numOfClicks === 0 || $correctAnswer2.prop('checked') && numOfClicks === 1 || $correctAnswer3.prop('checked') && numOfClicks === 2 || $correctAnswer4.prop('checked') && numOfClicks === 3 || $correctAnswer5.prop('checked') && numOfClicks === 4 || $correctAnswer6.prop('checked') && numOfClicks === 5 || $correctAnswer7.prop('checked') && numOfClicks === 6 || $correctAnswer8.prop('checked') && numOfClicks === 7 || $correctAnswer9.prop('checked') && numOfClicks === 8 || $correctAnswer10.prop('checked') && numOfClicks === 9 || $correctAnswer11.prop('checked') && numOfClicks === 10 || $correctAnswer12.prop('checked') && numOfClicks === 11 || $correctAnswer13.prop('checked') && numOfClicks === 12 || $correctAnswer14.prop('checked') && numOfClicks === 13 || $correctAnswer15.prop('checked') && numOfClicks === 14 || $correctAnswer16.prop('checked') && numOfClicks === 15 || $correctAnswer17.prop('checked') && numOfClicks === 16 || $correctAnswer18.prop('checked') && numOfClicks === 17 || $correctAnswer19.prop('checked') && numOfClicks === 18 || $correctAnswer20.prop('checked') && numOfClicks === 19 || $correctAnswer21.prop('checked') && numOfClicks === 20 || $correctAnswer22.prop('checked') && numOfClicks === 21 || $correctAnswer23.prop('checked') && numOfClicks === 22 || $correctAnswer24.prop('checked') && numOfClicks === 23 || $correctAnswer25.prop('checked') && numOfClicks === 24) {
